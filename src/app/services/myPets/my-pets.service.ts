  ...
  getMyPets() {
    let myPets = [
      ...
      },
      {
        ...
        morte: "✟ " + this.returnAtualDate(),
        historia:
          "Jasmin, uma cadela amorosa, trouxe felicidade para sua família. Com sua natureza gentil e olhos expressivos, ela se tornou uma companheira fiel. Jasmin era amigável e seu carinho sincero alegrava a todos ao seu redor. Sua presença iluminava a casa, destacando o poder especial dos animais de estimação em nossas vidas.",
      },
      {
        nome: "Petunia",
        imagem:
